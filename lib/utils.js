...
module.exports.tmpdir = function() {
  ...
  if (!tmpdir || (typeof tmpdir === 'undefined')) {
    tmpdir = os.tmpdir();
  }
...
module.exports.calculateBucketId = function(userId, bucketName) {
  var hash = module.exports.sha256(userId + bucketName, 'utf8').digest('hex');
